...
export default defineConfig({
  schema: [
    ...
    "./src/modules/backup/schema/*.ts",
    "./src/modules/config/schema/*.ts",
    "./src/modules/crm/schema/*.ts",
    "./src/modules/dvi/schema/*.ts",
    "./src/modules/intelligence/schema/*.ts",
    "./src/modules/label-printing/schema/*.ts",
    "./src/modules/scheduling/schema/*.ts",
    "./src/modules/security-hw/schema/*.ts",
    "./src/modules/whatsapp/schema/*.ts",
    "./src/modules/email/schema/*.ts",
    "./src/modules/api-keys/schema/*.ts",
    "./src/modules/enterprise/schema/*.ts",
  ],
